...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  /***/
  function node_modulesRawLoaderDistCjsJsSrcAppTodoListComponentHtml(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  function srcAppAppModuleTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var _todo_list_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(
    /*! ./todo-list.component */
    ...
    var _todo_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(
    /*! ./todo.service */
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
      declarations: [_app_component__WEBPACK_IMPORTED_MODULE_4__["AppComponent"], _todo_list_component__WEBPACK_IMPORTED_MODULE_6__["TodoListComponent"]],
      imports: [_angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_10__["MatSnackBarModule"], _angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_routing_module__WEBPACK_IMPORTED_MODULE_3__["AppRoutingModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_5__["BrowserAnimationsModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_7__["FormsModule"], _angular_common_http__WEBPACK_IMPORTED_MODULE_8__["HttpClientModule"]],
  ...
  /***/
  function srcAppTodoListComponentCss(module, __webpack_exports__, __webpack_require__) {
    "use strict";
  ...
  /***/
  function srcAppTodoListComponentTs(module, __webpack_exports__, __webpack_require__) {
    "use strict";
    ...
    /*#__PURE__*/
    function () {
      function TodoListComponent(snackBar) {
      ...
      _createClass(TodoListComponent, [{
        ...
        value: function ngOnInit() {
          ...
          if (savedTodos) {
            this.todos = JSON.parse(savedTodos).map(function (todo) {
          ...
          var savedAlerts = localStorage.getItem(this.alertsKey);
          this.alertsMap = savedAlerts ? JSON.parse(savedAlerts) : {}; // 3. Déclenchement IMMÉDIAT avec vérification forcée

          setTimeout(function () {
            console.log('Tâches chargées :', _this.todos);

            _this.checkDeadlines(true); // true = mode forcé
        ...
        value: function addTodo() {
          if (this.newTodo.title.trim() !== '') {
            this.newTodo.id = this.todos.length > 0 ? Math.max.apply(Math, _toConsumableArray(this.todos.map(function (t) {
              return t.id;
            }))) + 1 : 1;
        ...
        value: function getFilteredTodos() {
          ...
          return this.todos.filter(function (todo) {
            var matchesSearch = todo.title.toLowerCase().includes(_this2.searchTerm.toLowerCase());

            if (_this2.filter === 'completed') {
              return matchesSearch && todo.completed;
            }

            if (_this2.filter === 'pending') {
              return matchesSearch && !todo.completed && !_this2.isDeadlineOverdue(todo.deadline);
            }

            if (_this2.filter === 'overdue') {
              return matchesSearch && !todo.completed && _this2.isDeadlineOverdue(todo.deadline);
            }
        ...
        key: "isDeadlineToday",
        value: function isDeadlineToday(deadline) {
        ...
        key: "isDeadlineOverdue",
        value: function isDeadlineOverdue(deadline) {
          if (!deadline) return false;
          var today = new Date();
          var date = new Date(deadline);
        ...
        key: "isDeadlineTomorrow",
        value: function isDeadlineTomorrow(deadline) {
          if (!deadline) return false;
          var today = new Date();
        ...
        value: function checkDeadlines() {
          ...
          var messages = []; // Réinitialisation quotidienne des alertes
          ...
          this.todos.forEach(function (todo) {
            ...
            var isToday = deadlineDate.getTime() === today.getTime();
            var isTomorrow = new Date(today).setDate(today.getDate() + 1) === deadlineDate.getTime();
            var isOverdue = deadlineDate < today && !isToday;

            if (isToday || isTomorrow || isOverdue) {
              var alertKey = "".concat(todo.id, "_").concat(deadlineDate.toISOString().slice(0, 10));

              if (forceCheck || !_this3.alertsMap[alertKey]) {
                if (isToday) messages.push("\uD83D\uDEA8 \"".concat(todo.title, "\" - \xC0 faire AUJOURD'HUI"));else if (isTomorrow) messages.push("\u26A0\uFE0F \"".concat(todo.title, "\" - Pour DEMAIN"));else messages.push("\u274C \"".concat(todo.title, "\" - EN RETARD depuis ").concat(deadlineDate.toLocaleDateString()));
                _this3.alertsMap[alertKey] = true;
              }
            }
          });
        ...
        key: "playAlert",
        value: function playAlert() {
          this.alertSound.play().catch(function (err) {
            return console.log('Impossible de jouer le son :', err);
          });
        }
      }]);
    ...
    TodoListComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([Object(_angular_core__WEBPACK_IMPORTED_MODULE_3__["Component"])({
      selector: 'app-todo-list',
      template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! raw-loader!./todo-list.component.html */
      "./node_modules/raw-loader/dist/cjs.js!./src/app/todo-list.component.html")).default,
      styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(
      /*! ./todo-list.component.css */
      "./src/app/todo-list.component.css")).default]
    })], TodoListComponent);
    /***/
  },
  ...
  function srcAppTodoModelTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(
    /*! tslib */
    "./node_modules/tslib/tslib.es6.js"); // todo.model.ts


    var Todo = function Todo() // Priorité
    {
      ...
      var priority = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : 'low';
    ...
    function () {
      ...
      _createClass(TodoService, [{
        ...
        value: function getTodos() {
          return this.http.get(this.baseUrl + '/api/todos/').pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
        }
      }, {
        key: "createTodo",
        value: function createTodo(todoData) {
          return this.http.post(this.baseUrl + '/api/todos/', todoData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
        }
      }, {
        key: "updateTodo",
        value: function updateTodo(todoData) {
          return this.http.put(this.baseUrl + '/api/todos/' + todoData.id, todoData).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
        }
      }, {
        key: "deleteTodo",
        value: function deleteTodo(id) {
          return this.http.delete(this.baseUrl + '/api/todos/' + id).pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["retry"])(1), Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_4__["catchError"])(this.handleError));
        }
      }, {
        key: "handleError",
  ...
  function _(module, exports, __webpack_require__) {
    ...
    /*! C:\Users\user\OneDrive\Bureau\todo-app-spring-boot-angular\angular-frontend\src\main.ts */
    "./src/main.ts");
    /***/
  }
}, [[0, "runtime", "vendor"]]]);
